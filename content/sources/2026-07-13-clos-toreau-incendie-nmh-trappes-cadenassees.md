...
### Source primaire #1 — Lettre officielle NMH du 7 juillet 2026
- Courrier de la **Direction Générale Adjointe Habitat et Patrimoine** de **Nantes Métropole Habitat**, **Direction Transition Patrimoniale et Énergétique**, adressé aux **« Mesdames, Messieurs Les locataires »** du **2 au 14 rue Saint Jean de Luz, 44100 NANTES**.
- **Date** : Nantes, le **7 juillet 2026**.
- **Références** : Ns/réf. **2026-07-TMP N°633 ALL DG**. Dossier suivi par **Anne-Laure LEGEAY** (tél. 02.40.67.07.37).
- **Objet** : « **Intervention du cabinet Pouget et de la société SETEC — Diagnostic des dysfonctionnements** ».
- **Contenu** : annonce d'une démarche de diagnostic sur les parties communes et les logements. Prestataires : **cabinet Pouget** + **société SETEC**. Dates des visites : **22, 23, 27 juillet 2026** puis **31 août, 1er et 7 septembre 2026**. Précision en gras : « **Si votre logement est retenu pour une visite** » → diagnostic partiel, tous les logements ne seront pas visités.
- **Signataire** : « Le directeur général, par délégation, le responsable de la transition et maintenance du patrimoine, **Marc-Antoine ELIE** ».
- **Coordonnées émetteur** : Office Public de l'Habitat de la Métropole Nantaise, 26 place Rosa Parks – BP 83618 – 44036 Nantes cedex 1, tél. 02 40 67 07 37, Siren 274 400 027, www.nmh.fr.
- **Le mot « incendie » n'apparaît PAS dans la lettre.** Aucune mention explicite du sinistre nocturne. Fait éditorialement central de l'article.
- **Copie du document** dans le repo : [`content/media/2026-07-07-lettre-nmh-diagnostic-pouget-setec.jpeg`](../media/2026-07-07-lettre-nmh-diagnostic-pouget-setec.jpeg).

### Source primaire #2 — Photos du dispositif de désenfumage cadenassé
- Boîtier de commande manuel « **SÉCURITÉ INCENDIE — ÉVACUATION DES FUMÉES** » de marque **MADICOB** (Tél. 01 39 47 15 59), modèle certifié **NF S 61-937** (référence « NF 537 »), avec vignettes de vérification annuelle **2024** et **2025**. Consignes visibles : « EN CAS D'INCENDIE ABAISSER LE LEVIER », mécanisme de « FERMETURE » à manivelle, options **D.A.C. ÉLECTRIQUE** et **D.A.C. PNEUMATIQUE**.
- **Échelle démontable en aluminium** posée sur palier, **verrouillée par cadenas** (photo — cadenas visible et attaché sur la traverse).
- **Cage métallique** protégeant l'accès au dispositif, **fermée par cadenas massif** cadenassé sur bâti scellé mur.
- **Trappe d'exutoire ouverte** au plafond de la cage d'escalier (photo prise a posteriori, avec l'échelle déployée) — atteste de l'existence du dispositif conforme, dont l'accès est physiquement bloqué en fonctionnement normal.
- **Photos versionnées** dans le repo : le corpus des 5 clichés fournis par Khalid (uploads du 2026-07-13, série IMG_3767 à IMG_3777).

### Source primaire #3 — Photo de nuit de l'intervention pompiers
- Cliché pris depuis un balcon en hauteur, **en pleine nuit**, montrant un **camion de sapeurs-pompiers**, **grande échelle télescopique déployée**, **gyrophares bleus**, personnes au sol, bâtiment HLM éclairé. Utilisée comme fond de l'affiche `2026-07-13-clos-toreau-incendie-affiche.png`.

### Sources documentaires / techniques
- Norme **NF S 61-937** — Systèmes de Sécurité Incendie (SSI) — Dispositifs Actionnés de Sécurité (DAS) — cadre technique national des exutoires de désenfumage → [afnor.org — NF S 61-937](https://www.boutique.afnor.org/fr-fr/norme/nf-s61937-1/systemes-de-securite-incendie-ssi-dispositifs-actionnes-de-securite-das-p/fa049551).
- **MADICOB** — fabricant du boîtier de commande manuel identifié sur photo, société française de dispositifs pneumatiques de sécurité incendie → [madicob.com](https://www.madicob.com/).
...
### Dossier pilote UQL + courrier Monsieur Morineau (NMH) — épisode critique à documenter avec traces
...
- **Monsieur Morineau** — **chef de l'agence Goudy à Pirmil**, agence NMH gérant le quartier Clos-Toreau. Fonction et rattachement précisés par Khalid (correction de la première transcription « Moreno »). Cohérent avec la carte des agences NMH → [nmh.fr — agence Goudy / Clos-Toreau HLM](https://www.nmh.fr/NMH-L-office/Notre-patrimoine/Carte-des-logements/agence-goudy/CLOS-TOREAU-HLM). → **Action** : Khalid confirme l'**orthographe exacte du nom + prénom** (Morineau — un seul « n » ? « Morinneau » ?) avant publication. Nommer un cadre d'un office public dans un article qui questionne son honnêteté exige zéro erreur d'identité.

### Mépris de classe dans les courriers Morineau (méthode documentée)
- Au-delà du dossier pilote, Monsieur Morineau — et NMH — répondent régulièrement aux signalements documentés par des locataires suivi·es par l'UQL / LFI Clos-Toreau par des formulations écrites qui **rejettent la responsabilité sur les locataires** : « appelez votre assurance », « c'est à votre charge, cela relève des réparations locatives », « ce n'est pas de notre ressort ». Pratique caractérisée comme **mépris de classe** dans l'article.
- → **Action critique** : Khalid rassemble **plusieurs courriers Morineau** de différentes locataires (avec identités anonymisées) illustrant ce pattern, pour tenir la caractérisation « méthode » et « habitude » face à une éventuelle riposte de NMH. Un cas isolé se plaide comme un mécompris ; un pattern documenté sur plusieurs dossiers se plaide comme une politique d'agence.
- **Dossier pilote** transmis par LFI Nantes-Sud Clos-Toreau à NMH — dossier test sur une locataire du secteur suivie par l'UQL. Pièces au dossier :
  ...
  → **Action critique** : Khalid met à disposition, en interne rédaction, la **copie du dossier pilote envoyé à NMH** (accusé de réception ou preuve de dépôt) + copie de l'ordonnance médicale **anonymisée** (identité de la locataire et de sa fille masquée). Sans ces pièces sous la main, on ne tient pas en cas de recours en diffamation par NMH ou par Monsieur Morineau.
- **Visite de Monsieur Morineau** sur le terrain, **2 jours** après l'envoi du dossier, sur le prétexte des **coupures d'eau**. → **Action** : Khalid documente la date exacte de la visite + la date d'envoi du dossier (chronologie contredit-elle la version NMH).
- **Courrier écrit** de Monsieur Morineau évoquant avoir « rencontré » la locataire concernée qui aurait dit ne pas avoir de problème de moisissure. → **Action CRITIQUE** : Khalid met à disposition la **copie du courrier Moreno** (jpeg / scan). Sans ce document, le fait ne tient pas juridiquement. C'est le pivot de la section — sans papier, on retire ou on reformule au conditionnel généralisé.
...
- **Cause exacte de l'incendie** : « pris dans l'ascenseur » — non qualifiée davantage (électrique ? volontaire ?). L'enquête pompiers/police éclairera. → **Action** : suivre les suites de l'enquête pour un update.

## 👤 À valider par la rédaction

- **Témoignage « Hano »** : jeune du quartier héroïque de la nuit du 11-12 juillet, **d'origine soudanaise**, **livreur pour un grand groupe de livraison de colis** ; monté au 2ᵉ étage sortir sa sœur, puis frappé aux portes du palier, puis intervenu dans le hall en feu. Précisions apportées par Khalid après la première version de l'article (correction : premier prénom transcrit à tort « Anou »). → **Action critique** : Khalid confirme le **consentement explicite (écrit si possible) de Hano** à être nommé par ce prénom + origine + profession dans un article publié. La combinaison « prénom + origine soudanaise + livreur » rend l'intéressé aisément identifiable ; le consentement doit être clair, informé (l'article sera public et référencé) et documenté. Sinon, revenir à une forme anonymisée (« un jeune homme du quartier, d'origine soudanaise, travailleur »).
- **Description « les jeunes qui squattaient devant l'immeuble »** : reformulée en article en « jeunes du quartier » pour éviter la stigmatisation, tout en préservant l'idée que ce sont exactement les personnes que la commune préfère habituellement disperser. → **Action** : Khalid valide la reformulation.
- **Formulation dure sur NMH** (« un choix de gestion », « une politique », « ce ne sont pas des mots trop durs, ce sont les faits ») : cohérente avec la ligne éditoriale QL déjà adoptée sur les articles Bassal / Rolland / CRA. → **Action** : Khalid relit et durcit ou nuance selon.
- **Adressage direct « Madame Bassal, » en fin d'article** : forme éditoriale forte, assumée militante. → **Action** : Khalid valide ou reformule.
- **Nom « Union des Quartiers Libres »** : orthographe et statut de l'association tels que rapportés oralement par Khalid. → **Action** : orthographe officielle exacte + éventuelle URL / adresse à ajouter.
- **Mention de « Marie Vuitton »** citée oralement par Khalid comme responsable NMH : **volontairement omise** de l'article publiable en raison d'une incertitude d'orthographe et de fonction (probable confusion avec Marie Vitton, élue nantaise, ou avec une VP thématique). → **Action** : Khalid précise le nom et la fonction exacts si il souhaite qu'il·elle soit également nommé·e.

## Où vérifier (ressources générales)

- **Nantes Métropole Habitat** — site officiel : [nmh.fr](https://www.nmh.fr/)
- **Marc-Antoine ELIE**, responsable transition et maintenance du patrimoine (signataire de la lettre) — à contacter via NMH.
- **Anne-Laure LEGEAY**, en charge du dossier (tél. 02.40.67.07.37).
- **Cabinet Pouget** — bureau d'études thermique / énergétique / audit patrimonial (à identifier précisément parmi les cabinets « Pouget » du secteur).
- **Société SETEC** — groupe d'ingénierie française (SETEC est un grand groupe, préciser l'entité qui intervient : SETEC bâtiment, SETEC organisation, etc.).
- **Code de la construction et de l'habitation** — obligations désenfumage / SSI dans les immeubles d'habitation collectifs.
- **AFNOR / NF S 61-937** — norme technique des DAS et exutoires.
- **Sapeurs-pompiers de Loire-Atlantique (SDIS 44)** — pour rapport d'intervention éventuel : [sdis44.fr](https://www.sdis44.fr/).
